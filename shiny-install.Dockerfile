...
RUN R -e "install.packages(c('gsubfn','purrr','dplyr','pool','DBI','shiny','RMySQL','shinydashboard','rvest','tidyr','stringr','shinyjs','shinycssloaders','shinyjs','v8','DT','proto','rPython','highcharter','sodium'))"
