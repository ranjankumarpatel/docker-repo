...
RUN apt-get update &&  apt-get upgrade -y &&  apt install -y build-essential dirmngr gnupg apt-transport-https ca-certificates software-properties-common gcc-9-base
